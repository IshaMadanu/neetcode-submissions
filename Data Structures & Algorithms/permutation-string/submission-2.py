    ...
    def checkInclusion(self, s1: str, s2: str) -> bool:
        ...
        for right in range(len(s1), len(s2)):
            ...
            if count1[index] == count2[index]:
                match += 1
            elif count1[index] + 1 == count2[index]: #if moving window canges equal counts, then descemnt match
                match -= 1
            ...
            if count1[index] == count2[index]:
                match += 1
            elif count1[index] - 1 == count2[index]: #if index's count - 1(after subtracting left) is == count in 2
                match -= 1
